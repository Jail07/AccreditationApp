...
RUN apt-get update && apt-get install -y \
    ...
    wget tar libglu1-mesa libxrender1 libxi6 libxrandr-dev \
    libxcb-xinerama0 libxcb1 libx11-xcb1 libgl1-mesa-glx \
    xorg-dev libxcb-render-util0 libxcb-shm0 xvfb x11vnc tzdata && \
...
RUN cd /root && \
    ...
    make -j$(nproc) && \
    make install && \
    rm -rf /root/qt-everywhere-src-5.15.3 /root/tqtc-qt5-everywhere-opensource-src-5.15.3.tar.xz
